        ...
        <DialogContent className="sm:max-w-[500px] bg-white border-zinc-200 p-0 overflow-hidden rounded-2xl shadow-2xl">
          ...
          <div className="relative p-6 pb-5 border-b border-zinc-100 bg-zinc-50/50">
            ...
            <DialogHeader>
              ...
              <DialogDescription className="text-xs text-zinc-500 mt-2 leading-relaxed pl-11">
                Enter the primary details for the new store. The vendor will receive an email to set up their password and complete KYC.
              </DialogDescription>
            </DialogHeader>
          </div>
          ...
          <form onSubmit={handleSaveVendor} className="p-6 space-y-5">
            <div className="space-y-1.5">
              <Label htmlFor="storeName" className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="category" className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
